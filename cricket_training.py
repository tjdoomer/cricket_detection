...
def process_video(video_path, classifier, hog):
    ...
    cv2.namedWindow('Cricket Detection', cv2.WINDOW_NORMAL)
    cv2.resizeWindow('Cricket Detection', width, height)
    ...
    while True:
        ...
        # Process frame in native resolution
        ...
        cv2.imshow('Cricket Detection', frame)
